defmodule Imglab.UrlTest do
  ...
  describe "url/3 using source" do
    ...
    test "with params", %{source: source} do
    ...
    test "with params using string path with inline params", %{source: source} do
      url = Imglab.url(source, "example.jpeg", width: 200, height: 300, watermark: "example.svg?width=100&format=png", format: "png")

      assert url == "https://assets.imglab-cdn.net/example.jpeg?width=200&height=300&watermark=example.svg%3Fwidth%3D100%26format%3Dpng&format=png"
    end

    test "with params using url/3 with source", %{source: source} do
      url =
        Imglab.url(
          source,
          "example.jpeg",
    ...
    test "with params using url/3 function with source name", %{source: source} do
      url =
        Imglab.url(
          source,
          "example.jpeg",
    ...
    test "with params using atoms with underscores", %{source: source} do
      url = Imglab.url(source, "example.jpeg", trim: "color", trim_color: "orange")

      assert url == "https://assets.imglab-cdn.net/example.jpeg?trim=color&trim-color=orange"
    end

    test "with expires param using a DateTime struct", %{source: source} do
      url = Imglab.url(source, "example.jpeg", width: 200, height: 300, expires: DateTime.from_unix!(1464096368))

      assert url == "https://assets.imglab-cdn.net/example.jpeg?width=200&height=300&expires=1464096368"
    end

    test "with params using atoms with hyphens", %{source: source} do
    ...
    test "with path starting with slash", %{source: source} do
      url = Imglab.url(source, "/example.jpeg", width: 200, height: 300, format: "png")

      assert url == "https://assets.imglab-cdn.net/example.jpeg?width=200&height=300&format=png"
    end

    test "with path starting with slash using reserved characters", %{source: source} do
      url = Imglab.url(source, "/example image%2C01%2C02.jpeg", width: 200, height: 300, format: "png")

      assert url == "https://assets.imglab-cdn.net/example%20image%252C01%252C02.jpeg?width=200&height=300&format=png"
    end

    test "with path starting and ending with slash", %{source: source} do
      url = Imglab.url(source, "/example.jpeg/", width: 200, height: 300, format: "png")

      assert url == "https://assets.imglab-cdn.net/example.jpeg?width=200&height=300&format=png"
    end

    test "with path starting and ending with slash using reserved characters", %{source: source} do
      url = Imglab.url(source, "/example image%2C01%2C02.jpeg/", width: 200, height: 300, format: "png")

      assert url == "https://assets.imglab-cdn.net/example%20image%252C01%252C02.jpeg?width=200&height=300&format=png"
    end

    test "with subfolder path starting with slash", %{source: source} do
      url = Imglab.url(source, "/subfolder/example.jpeg", width: 200, height: 300, format: "png")

      assert url == "https://assets.imglab-cdn.net/subfolder/example.jpeg?width=200&height=300&format=png"
    end

    test "with subfolder path starting with slash using reserved characters", %{source: source} do
      url = Imglab.url(source, "/subfolder images/example image%2C01%2C02.jpeg", width: 200, height: 300, format: "png")

      assert url == "https://assets.imglab-cdn.net/subfolder%20images/example%20image%252C01%252C02.jpeg?width=200&height=300&format=png"
    end

    test "with subfolder path starting and ending with slash", %{source: source} do
      url = Imglab.url(source, "/subfolder/example.jpeg/", width: 200, height: 300, format: "png")

      assert url == "https://assets.imglab-cdn.net/subfolder/example.jpeg?width=200&height=300&format=png"
    end

    test "with subfolder path starting and ending with slash using reserved characters", %{source: source} do
      url = Imglab.url(source, "/subfolder images/example image%2C01%2C02.jpeg/", width: 200, height: 300, format: "png")

      assert url == "https://assets.imglab-cdn.net/subfolder%20images/example%20image%252C01%252C02.jpeg?width=200&height=300&format=png"
    end

    test "with path using a http url", %{source: source} do
      url = Imglab.url(source, "http://assets.com/subfolder/example.jpeg", width: 200, height: 300, format: "png")

      assert url == "https://assets.imglab-cdn.net/http%3A%2F%2Fassets.com%2Fsubfolder%2Fexample.jpeg?width=200&height=300&format=png"
    end

    test "with path using a http url with reserved characters", %{source: source} do
      url = Imglab.url(source, "http://assets.com/subfolder/example%2C01%2C02.jpeg", width: 200, height: 300, format: "png")

      assert url == "https://assets.imglab-cdn.net/http%3A%2F%2Fassets.com%2Fsubfolder%2Fexample%252C01%252C02.jpeg?width=200&height=300&format=png"
    end

    test "with path using a https url", %{source: source} do
      url = Imglab.url(source, "https://assets.com/subfolder/example.jpeg", width: 200, height: 300, format: "png")

      assert url == "https://assets.imglab-cdn.net/https%3A%2F%2Fassets.com%2Fsubfolder%2Fexample.jpeg?width=200&height=300&format=png"
    end

    test "with path using a https url with reserved characters", %{source: source} do
  ...
  describe "url/3 using secure source" do
    ...
    test "with params using url/3 function with source", %{source: source} do
      url =
        Imglab.url(
          source,
          "example.jpeg",
